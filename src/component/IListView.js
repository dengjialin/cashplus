...
import {IRefreshScrollView,RefreshTitle,RefreshStatus} from './IScrollView'
/**
 *===============================================SwRefreshListView=====================================
 */
/**
...
export class IRefreshListView extends ListView{
    _isLoading = false
    // 构造
    constructor(props) {
        super(props);
    ...
    render(){
        return(
            <ListView
                ...
                renderScrollComponent={(props) => <IRefreshScrollView ref={(scrollView)=>{
                    if (scrollView){
        ...
        if (this.state.loadStatus == LoadMoreStatus.noMoreData){
            ...
            return(
                <View>
                    ...
                    <View style={footStyles.footer}>
                        {/*<ActivityIndicator/>*/}
                        <Text style={footStyles.footerText}>{this.props.pushToLoadMoreTitle}</Text>
                    </View>
                </View>
            )
